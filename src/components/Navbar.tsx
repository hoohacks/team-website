...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-100 font-chakra-petch p-4 md:p-8 lg:p-16">
      <div className="flex flex-wrap items-center justify-between">
        {/* Logo and Links */}
        <div className="flex items-center justify-start gap-4 md:gap-8 lg:gap-16 pl-4 md:pl-8 lg:pl-20">
          <img
            src={owlLogo}
            alt="Owl Logo"
          ...
          />
          {/* Links */}
          <div className="hidden md:flex md:items-center gap-4 md:gap-8 lg:gap-16">
            <a
              href="/"
        ...
        >
          <div className="flex flex-col items-start gap-4 mt-4">
            <a
              href="/"
              className="font-bold text-sm text-[#121A6A] relative overflow-hidden group"
            >
              About
              <span className="absolute left-0 bottom-0 w-full h-0.5 bg-[#121A6A] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-in-out"></span>
            </a>
